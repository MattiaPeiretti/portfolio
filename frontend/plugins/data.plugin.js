...
const allCases = [
  {
    id: 1,
    slug: "birth-of-phobosmedia",
    title: "Birth of PhobosMedia",
    except:
      "In 2021 I opened my first company: PhobosMedia. Read this article if you want to know how that happened.",
  ...
  {
    id: 2,
    slug: "quantum-computing-and-more",
    title: "Quantum Computing and more",
    except:
      "In 2020, thanks to my school, I partook to a pilot with the university of Amsterdam, about Quantum Computing.",
    body: "Back in 2020, my highschool organized a pilot with the university of Amsterdam, regarding quantum computing. Which I found extremely interesting. We learn about most of the linear algebra behind it, subsequently we learned about quantum circuits, gates, and complex operations, and finally we learned how to devise quantum algorithms. At the end I passed as one of the best 7 partakers of the pilot, and got gifted two wonderful books from the main professor of the course: Dr. Micheal Walter. A year after that, when I had to write my profile essay for school, I decided to write it about quantum computing. Which revealed to be a huge learning opportunity. I got to interview a researcher from the University of Amsterdam, Dr. F. Speelman. And I also wrote an experiment and ran it on a real IBM quantum computer.",
    date: "7th of April, 2022",
    emoji: "⚛",
  },
  {
    id: 3,
    slug: "science-related-projects",
